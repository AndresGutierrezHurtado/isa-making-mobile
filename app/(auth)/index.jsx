        ...
        <View className="flex-1 flex-col bg-base-100">
            ...
            <View className="p-10 h-fit items-center gap-10">
                <View className="gap-4">
                    <Text className="text-3xl text-center font-bold text-base-content leading-[100%]">
                        Compra <Text className="text-primary">las mejores</Text> prendas
                    </Text>
                    <Text className="text-lg text-center text-base-content opacity-80 leading-[100%]">
                        Autenticate con tu cuenta para acceder a tu tienda
                    </Text>
                </View>
                <View className="flex-row gap-5 w-full">
                    <Pressable
                        className="bg-primary rounded px-5 py-2 grow active:opacity-80 duration-300"
                        onPress={() => router.push("/login")}
                    >
                        <Text className="text-sm text-base-content text-center">
                            Iniciar sesión
                        </Text>
                    </Pressable>
                    <Pressable
                        className="bg-transparent rounded px-5 py-2 grow border border-primary active:bg-primary/40 duration-300"
